...
import { getList, del } from '../../actions/Tipo_Producto-action'
...
class List extends Component {
    ...
    handleClick = () => {
        this.props.history.push('/catalogo/Tipo_Producto/new');
    }
                    ...
                    <Paper style={{
                        ...
                        <Table>
                            <TableHead>
                                <TableRow>
                                    <TableCell>#</TableCell>
                                    <TableCell >producto_nombre</TableCell>
                            ...
                            <TableBody>
                                {list.map((d, index) =>
                                    <TableRow key={index}>
                                        ...
                                        <TableCell >
                                            <Link to={`/catalogo/Tipo_Producto/edit/${d.id}`} className="ui basic button green">Edit</Link>
                                        </TableCell>
                                        <TableCell >
