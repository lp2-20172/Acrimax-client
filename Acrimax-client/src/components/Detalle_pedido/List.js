...
import { getList, del } from '../../actions/Detalle_pedido-action'
...
class List extends Component {
    ...
    handleClick = () => {
        this.props.history.push('/catalogo/Detalle_pedido/new');
    }
                    ...
                    <Paper style={{
                        ...
                        <Table>
                            <TableHead>
                                <TableRow>
                                    <TableCell>#</TableCell>
                                    <TableCell >pedido_nombre</TableCell>
                                    <TableCell >detalle_pedido</TableCell>
                            ...
                            <TableBody>
                                {list.map((d, index) =>
                                    <TableRow key={index}>
                                        ...
                                        <TableCell >{d.pedido_nombre}</TableCell>
                                        <TableCell >{d.detalle_pedido}</TableCell>
                                        <TableCell >{d.estado}</TableCell>
                                        <TableCell >{d.fecha_pedido}</TableCell>
                                        <TableCell >
                                            <Link to={`/catalogo/Detalle_pedido/edit/${d.id}`} className="ui basic button green">Edit</Link>
                                        </TableCell>
                                        <TableCell >
...
const mapStateToProps = (state) => {
    return {
        list: state.Detalle_pedido.list
    }
}
