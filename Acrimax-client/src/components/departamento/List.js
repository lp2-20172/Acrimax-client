...
import { getList, del } from '../../actions/departamento-action'
...
class List extends Component {
    ...
    handleClick = () => {
        this.props.history.push('/catalogo/departamento/new');
    }
                            ...
                            <TableBody>
                                {list.map((d, index) =>
                                    <TableRow key={index}>
                                        ...
                                        <TableCell >
                                            <Link to={`/catalogo/departamento/edit/${d.id}`} className="ui basic button green">Edit</Link>
                                        </TableCell>
                                        <TableCell >
