...
import { getList, del } from '../../actions/pedido-action'
...
class List extends Component {
    ...
    handleClick = () => {
        this.props.history.push('/catalogo/pedidos/new');
    }
                            ...
                            <TableBody>
                                {list.map((d, index) =>
                                    <TableRow key={index}>
                                        ...
                                        <TableCell >
                                            <Link to={`/catalogo/pedidos/edit/${d.id}`} className="ui basic button green">Edit</Link>
                                        </TableCell>
                                        <TableCell >
