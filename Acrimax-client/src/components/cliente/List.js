...
class List extends Component {
    ...
    handleClick = () => {
        this.props.history.push('/catalogo/cliente/new');
    }
                            ...
                            <TableBody>
                                {list.map((d, index) =>
                                    <TableRow key={index}>
                                        ...
                                        <TableCell >{d.person_first_name}</TableCell>
                                        <TableCell >
                                            <Link to={`/catalogo/cliente/edit/${d.id}`} className="ui basic button green">Edit</Link>
                                        </TableCell>
                                        <TableCell >
