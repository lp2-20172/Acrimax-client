...
class List extends Component {
    ...
    handleClick = () => {
        this.props.history.push('/catalogo/unidadMed/new');
    }
                            ...
                            <TableBody>
                                {list.map((d, index) =>
                                    <TableRow key={index}>
                                        ...
                                        <TableCell >
                                            <Link to={`/catalogo/unidadMed/edit/${d.id}`} className="ui basic button green">Edit</Link>
                                        </TableCell>
                                        <TableCell >
